...
{
    /**
     * Retorna a view da página de minhas solcitações finalizadas
     * @return string
     */
    public static function getSolicitation($request)
    {
        $content = View::render("pages/solicitation/finished/index", [
    ...
    private static function getItens($request)
    {
        ...
        {
            return View::render("pages/solicitation/finished/no_solicitation");
        }
        ...
        foreach ($solicitationsOrdered as $item)
        {
            ...
            $content .= View::render("pages/solicitation/finished/item", [
                "id" => $item->id,
                "lista" => $lista,
