...
class Student
{
    ...
    {
        return self::processData(self::getStudents("email = '".$email."'"))[0] ?? null;
    }
    ...
    {
        return self::processData(self::getStudents("id = ".$id))[0] ?? null;
    }
     ...
     * @return Student
     */
    public static function getStudentByIdRefeitorio($id)
    {
        return self::processData(self::getStudents("id_refeitorio = ".$id))[0] ?? null;
    }
     ...
     * @return \PDOStatement
     */
    public static function getStudents($where = null, $order = null, $limit = null, $field = "*")
    {
    ...
    /**
     * Processa dados PDOStatement para instâncias de Student
     * @param \PDOStatement
     * @return array|null
     */
